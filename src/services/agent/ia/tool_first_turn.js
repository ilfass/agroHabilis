...
const buildSystemPrompt = ({ usuario, historialReciente }) => {
  ...
  return [
    ...
    "",
    "REGLA DE VISIÓN: Si el mensaje contiene un tag '[Análisis de archivo: ...]', consideralo como contexto visual directo de lo que el productor te envió (fotos o documentos). Usalo para responder sobre sanidad, conteos, malezas o lectura de tickets como si lo estuvieras viendo.",
    "",
    ...
    "   - Mantené los bloques con ━━━━━━━━ si ayudan a leer los precios o el clima.",
