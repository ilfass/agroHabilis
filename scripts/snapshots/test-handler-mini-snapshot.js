...
require.cache[planesPath] = {
  ...
  exports: {
    validarLimitesSemanales: async () => ({
      ok: state.cupoOk,
      mensaje: state.cupoOk ? null : `Alcanzaste tu límite semanal de uso. Pasate a un plan superior para continuar. (Límite: ${state.cupoLimite})`,
      razon: "consultas",
      usadas: state.cupoLimite,
      limite: state.cupoLimite
    }),
  },
};
