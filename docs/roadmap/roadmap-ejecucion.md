...
- [x] Implementar consultas entrantes por WhatsApp con IA y persistencia en `historial_consultas`.
...
- [x] Consultas por WhatsApp respondidas con IA usando contexto desde DB (`precios`, `tipo_cambio`, `usuario_cultivos`).
- [x] Deploy VPS estabilizado para `whatsapp-web.js` (sesion dedicada en servidor y checklist de dependencias Chromium).
...
- [x] Script/comando unico de corrida manual MVP.
